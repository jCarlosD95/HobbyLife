        ...
        <form class="form-inline my-2 my-lg-0" action="search.php" method="get">
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <div name="search_type" class="dropdown-menu">
                    <a class="dropdown-item" value="user" href="#">User</a>
                    <a class="dropdown-item" value="org" href="#">Organization</a>
                    <a class="dropdown-item" value="event" href="#">Event</a>
                  </div>
                </div>
